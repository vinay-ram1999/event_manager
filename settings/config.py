...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='7d5f7655327ce7', description="Username for SMTP server")
    smtp_password: str = Field(default='0de2437b0030b9', description="Password for SMTP server")
