...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='dadf940cba921a', description="Username for SMTP server")
    smtp_password: str = Field(default='c40c8c21fd43b1', description="Password for SMTP server")
